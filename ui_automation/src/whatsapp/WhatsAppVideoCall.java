...
public class WhatsAppVideoCall implements executeFunctionality {
    ...
    public WhatsAppVideoCall(String udID1, String udID2) {
    ...
    protected void whatsappVideoCalling(int call_duration) throws Exception {

        System.out.println("Entering Func whatsappVideoCalling");
        ...
        appiumWebDriver1.findElementAndPerformAction("id","contactpicker_videocall_button","click","Calling Mobile1",2000);
        try {
            appiumWebDriver2.findElementAndPerformAction("id", "decline_incoming_call_view", "swipeUpShakingButton", "Call Declined",2000);
        } catch(Exception ex) {
            System.out.println("\n\n Video Call Missed, Trying Again");
            appiumWebDriver1.findElementAndPerformAction("id","call_back_btn","click","Calling....",2000);
            appiumWebDriver2.findElementAndPerformAction("id", "decline_incoming_call_view", "swipeUpShakingButton", "Video Call Declined in 2nd Attempt",2000);
        }

        //ACCEPT
        appiumWebDriver1.findElementAndPerformAction("contentDesc", "New call", "click", "Again Clicked Call Button",1000);
        appiumWebDriver1.findElementAndPerformAction("id","contactpicker_videocall_button","click","Again Calling Mobile1",2000);
        try {
            appiumWebDriver2.findElementAndPerformAction("id", "accept_incoming_call_view", "swipeUpShakingButton", "Video Call Answered",0);
        } catch (Exception ex) {
            System.out.println("\n\nVideo Call Missed, Trying Again");
            appiumWebDriver1.findElementAndPerformAction("id","call_back_btn","click","Calling....",2000);
            appiumWebDriver2.findElementAndPerformAction("id", "accept_incoming_call_view", "swipeUpShakingButton", "Video Call Answered in 2nd Attempt",0);
        }
        ...
        System.out.println("Exiting Func whatsappVideoCalling");
    }

    @Override
    public void execute() {
        try {
            whatsappVideoCalling(120000);
            PrintWriter writer = new PrintWriter("/tmp/browsing_success", "UTF-8");
            writer.println("1");
            writer.close();
            System.out.println("Written Success Status");
        } catch (Exception exp) {
            System.out.println("Exception in whatsappVideoCalling Execution");
        }
