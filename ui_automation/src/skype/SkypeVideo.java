...
public class SkypeVideo implements executeFunctionality {
    ...
    public SkypeVideo(String udID1, String udID2) {
    ...
    protected void SkypeVideoCall(int call_duration) throws Exception {
        System.out.println("Entered function SkypeVideoCall");
        ...
        //ACCEPT SCENARIO
        appiumWebDriver1.findElementAndPerformAction("contentDesc","Video Call","click","Calling....",2000);
        appiumWebDriver2.findElementAndPerformAction("contentDesc","Answer call from "+mob1+" with video","click","Answered Video Call",call_duration);
        appiumWebDriver1.touchAction.tap(360,550).perform();
        Thread.sleep(1000);
        appiumWebDriver1.findElementAndPerformAction("contentDesc","Turn video off","click","Made Video OFF",10000);
        appiumWebDriver1.touchAction.tap(360,550).perform();
        Thread.sleep(1000);
        ...
        //DECLINE SCENARIO
        try {
            appiumWebDriver1.findElementAndPerformAction("contentDesc", "Video Call", "click", "Calling Again...", 2000);
            appiumWebDriver2.findElementAndPerformAction("contentDesc","Decline","click","Rejected Video Call",2000);
        } catch (Exception ex) {
            System.out.println("Unexpected Screen.. Going back and retry");
            appiumWebDriver1.backScreen(1,2000);
            appiumWebDriver1.findElementAndPerformAction("contentDesc", "Video Call", "click", "Calling Again...", 1000);
            appiumWebDriver2.findElementAndPerformAction("contentDesc","Decline","click","Rejected Video Call",2000);
        }

        System.out.println("Exiting function SkypeVideoCall");
    }
