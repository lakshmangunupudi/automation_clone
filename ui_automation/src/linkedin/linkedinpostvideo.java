 ...
 */
public class linkedinpostvideo implements executeFunctionality {

    AppiumWebDriver appiumWebDriver;

    public linkedinpostvideo(String udID) {
    ...
    //this method is to uplaod the videos
    private void shareVideosLinkedin() throws Exception {
            ...
            for (int i = 0; i < 2; i++) {
                    ...
                    appiumWebDriver.findElementAndPerformAction("id", "sharing_compose_attach_video_button", "click", "Clicked on video button of new post  of linkedin ", 2000);
                    appiumWebDriver.findElementAndPerformAction("osId", "text1", "click", "Clicked on capture video using camera option  of linkedin post", 5000);
                    appiumWebDriver.findElementAndPerformAction("plainId", "com.android.camera:id/v6_shutter_button_internal", "click", "Clicked on capture video using camera option  of linkedin post", 5000);
                    
                    appiumWebDriver.findElementAndPerformAction("plainId", "com.android.camera:id/v6_shutter_button_internal", "click", "Clicked on STOP capture video using camera option  of linkedin post", 5000);

                    appiumWebDriver.findElementAndPerformAction("plainId", "com.android.camera:id/v6_btn_done", "click", "Clicked on accept video to upload of linkedin post", 10000);
