 ...
 */
public class facebookmessanger_message implements executeFunctionality{

    AppiumWebDriver appiumWebDriver1;
    AppiumWebDriver appiumWebDriver2;
    private static final String ALPHA_NUMERIC_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
    public facebookmessanger_message(String udID1,String udID2) {
    ...
    private void facebookAudioCall() throws Exception {
        ...
        for (int i=0;i<5;i++){
            appiumWebDriver1.keyStroke = this.randomAlphaNumeric(i)+String.valueOf(i);
            appiumWebDriver1.findElementAndPerformAction("text", "Aa", "typeText", "Clicked on  audio call  icon of facebook im", 100);
            appiumWebDriver1.findElementAndPerformAction("accessId", "Send", "click", "Clicked on  audio call  icon of facebook im", 100);    

            appiumWebDriver2.keyStroke = "hi how are you igkgkgkjgkjgkjgkgkjgkgkkgkgkgkjgqlbdqlbl "+String.valueOf(i);
            appiumWebDriver2.findElementAndPerformAction("text", "Aa", "typeText", "Clicked on  audio call  icon of facebook im", 100);
            appiumWebDriver2.findElementAndPerformAction("accessId", "Send", "click", "Clicked on  audio call  icon of facebook im", 100);    
        }
    ...
    public void execute() {
        ...
        try {
            ...
            System.out.println("Exception in Facebook IM Execution");
