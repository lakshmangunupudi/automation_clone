...
public class ViberVideoCall implements executeFunctionality {
    ...
    public ViberVideoCall(String udID1, String udID2) {
    ...
    protected void viberVideoCalling(int call_duration) throws Exception {
        System.out.println("Entering Func viberVideoCalling");
        //ACCEPT
        ...
        appiumWebDriver1.findElementAndPerformAction("id","menu_video_call","click","Calling.....",7000);
        ...
        Thread.sleep(1000);
        appiumWebDriver2.findElementAndPerformAction("id","video","click","Made Video OFF",30000);
        appiumWebDriver2.touchAction.tap(300,600).perform();
        Thread.sleep(1000);
        ...
        //DECLINE
        try {
            appiumWebDriver1.findElementAndPerformAction("id","menu_video_call","click","Calling Again.....",7000);
        }catch (Exception ex) {
        ...
        Thread.sleep(5000);
        System.out.println("Exiting Func viberVideoCalling");
