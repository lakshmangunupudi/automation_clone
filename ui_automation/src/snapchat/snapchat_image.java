 ...
 */
public class snapchat_image implements executeFunctionality{

    AppiumWebDriver appiumWebDriver1;
    AppiumWebDriver appiumWebDriver2;
    
    public snapchat_image(String udID1,String udID2) {
    ...
    private void sendSnapchatimage() throws Exception {
        ...
        for(int i=0;i<2;i++){
            ...
            appiumWebDriver1.findElementAndPerformAction("id", "chat_camera_button", "click", "Clicked on camera icon on snapchat app", 1000);
            appiumWebDriver1.findElementAndPerformAction("id", "nueva_nav_default_camera_button", "click", "Clicked on camera icon on snapchat app", 1000);
            
            appiumWebDriver1.findElementAndPerformAction("id", "send_to_bottom_panel_send_button_container", "click", "Clicked on send image  on snapchat app", 1000);
            
    
            appiumWebDriver2.findElementAndPerformAction("id", "chat_camera_button", "click", "Clicked on camera icon on snapchat app", 1000);
            appiumWebDriver2.findElementAndPerformAction("id", "nueva_nav_default_camera_button", "click", "Clicked on camera icon on snapchat app", 1000);
            
            appiumWebDriver2.findElementAndPerformAction("id", "send_to_bottom_panel_send_button_container", "click", "Clicked on camera icon on snapchat app", 1000);
    ...
    public void execute() {
        ...
        try {
            ...
            System.out.println("Exception in snapchat image Execution");
