 ...
 */
public class snapchat_audio implements executeFunctionality{

    AppiumWebDriver appiumWebDriver1;
    AppiumWebDriver appiumWebDriver2;
    
    public snapchat_audio(String udID1,String udID2) {
    ...
    private void snapchatVideoCall() throws Exception {
        ...
        appiumWebDriver2.findElementAndPerformAction("id", "audio_call_container", "click", "Clicked on audio icon on snapchat app", 1000);
        appiumWebDriver1.findElementAndPerformAction("id", "call_prompt_join_button_container", "click", "Clicked on accept audio call on snapchat app", 100000);
        
        appiumWebDriver2.findElementAndPerformAction("id", "end_stream_audio_button", "click", "Clicked on camera icon on snapchat app", 1000);



        appiumWebDriver1.findElementAndPerformAction("id", "audio_call_container", "click", "Clicked on audio icon on snapchat app", 1000);
        appiumWebDriver2.findElementAndPerformAction("id", "call_prompt_join_button_container", "click", "Clicked on accept audio call on snapchat app", 100000);
        appiumWebDriver1.findElementAndPerformAction("id", "end_stream_audio_button", "click", "Clicked on camera icon on snapchat app", 1000);
    ...
    public void execute() {
        ...
        try {
            ...
            System.out.println("Exception in snapchat audio call Execution");
